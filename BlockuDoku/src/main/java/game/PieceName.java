...
public enum PieceName {
    ...
    /**
     * Overrides the toString() method in order to return a String object
    ...
    public String toString() {
        ...
        switch (this) {
            ...
            case I_THREE_BLOCK:
                return "I Three Block";

            case L_MINIMUM_BLOCK:
                return "L Minimum Block";

            case L_MAXIMUM_BLOCK:
                return "L Maximum Block";

            case T_EXTENDED_BLOCK:
                return "T Extended Block";

            case Q_EXTENDED_BLOCK:
                return "Q Extended Block";
