...
public class BlockGenerator {
    ...
    /**
     * Static method nextAdvancedBlock randomizes a number between [1,13] and
     * then generates a pieces according to that number
     *
    ...
    public static Piece nextAdvancedBlock() {
        ...
        switch (number) {
            case 1:
                return new IOneBlock();

            case 2:
                return new ITwoBlock();

            case 3:
                return new IThreeBlock();
            ...
            case 6:
                return new LMaximumBlock();

            case 7:
                return new LMinimumBlock();

            case 8:
                return new QBlock();

            case 9:
                return new QExtendedBlock();
    ...
    /**
     * Static method nextBasicBlock randomizes a number between [1,13] and then
     * generates a pieces according to that number
     *
     * @return The piece that was randomly generated
     */
