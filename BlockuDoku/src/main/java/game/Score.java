...
/**
 * This class Serves as helper implementing the Comparable Interface in order to
 * help us sort our Lists
 *
...
public class Score<E> implements Comparable<Score<E>>, Serializable {
     ...
     * @return int difference between Objects allows us to determine if one is
