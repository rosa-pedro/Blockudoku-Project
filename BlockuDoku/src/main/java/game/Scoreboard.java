...
/**
 * This class Stores the ArrayList of scores of type Score<E>
 *
...
public class Scoreboard<E> implements Serializable {
    ...
    private ArrayList<Score<E>> scoreboard;
    private E element;
    ...
    /**
     * Creates a Score Object based off the element and score and inserts it
     * into the scoreboard
     *
     * @param element E
     * @param score int
