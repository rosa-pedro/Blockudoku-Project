...
public class BoardCleanUpLogic {
    ...
    /**
     * Method that cleans up the board by checking if there are any completed
     * Squares Rows or Columns and returns the according points
     *
    ...
    /**
     * Gets the square section, a square is defined by the first coordinate(top
     * left) and last cord (bottom right)
     *
