...
/**
 * This class serves to format String inputs into commands used in game
 *
 *
...
public class Command {
    ...
    /**
     * Constructor for Command class, takes two string and turns them into a
     * Command
     *
     ...
     *
     * @param board
     * @return true if the command is valid, false if the coordCommand does not
    ...
    /**
     * Uses isBlockCommandValid() and isCoordCommandvalid(board) to check if the
     * command object is valid
     *
     * @param board
