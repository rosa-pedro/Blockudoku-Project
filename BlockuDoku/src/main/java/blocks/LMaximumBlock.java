...
public class LMaximumBlock extends Piece {
    ...
    /**
     * Constructor for class LMaximumBlock, creates a piece after the PieceName
     * enum.
     */
     ...
     * LMaximumBlock with zero degree rotation.
     */
    @Override
     ...
     * LMaximumBlock with ninety degree rotation.
     */
    @Override
     ...
     * LMaximumBlock with hundred and seventy degree rotation.
     */
    @Override
     ...
     * represent a LMaximumBlock with two hundred and seventy degree rotation
     */
    @Override
