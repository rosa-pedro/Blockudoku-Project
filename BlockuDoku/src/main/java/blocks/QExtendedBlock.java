...
public class QExtendedBlock extends Piece {
    ...
    /**
     * Constructor for class QExtendedBlock, creates a piece after the PieceName
     * enum.
     */
     ...
     * QExtendedBlock with zero degree rotation.
     */
    @Override
     ...
     * QExtendedBlock with hundred and seventy degree rotation, since the
     * QExtendedBlock is shaped like a square its rotation is redundant this
     ...
     * represent a QExtendedBlock with two hundred and seventy degree rotation,
     * since the QExtendedBlock is shaped like a square its rotation is
     * redundant this buildPieceWithzeroRotation() is recalled.
     */
    @Override
