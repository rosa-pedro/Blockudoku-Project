...
/**
 * This class consists exclusively of void methods that help building SBlock
 * Piece
 *
 *
...
public class SBlock extends Piece {
     ...
     * SBlock with hundred and seventy degree rotation, since the SBlock is
     * shaped like an s laid on its side whether it has suffered hundred and
     * eighty or no rotation is indifferent thus the
     * buildPieceWithzeroRotation() method is recalled.
     */
    @Override
     ...
     * Overrides the method buildPieceWithHundredEightyRotation() to represent a
     * SBlock with hundred and seventy degree rotation, since the SBlock is
     * shaped like an s laid on its side whether it has suffered two hundred and
     * seventy or ninety rotation is indifferent thus the
     * buildPieceWithNinetyRotation() method is recalled.
     */
    @Override
